...
const createProfileFormSchema = (t: TTranslationFunction) =>
  z.object({
    ...
    title: z
      .string()
      .max(100, t('validation.profile.titleMaxLength'))
      .optional()
      .or(z.literal('')),
    university: z
      .string()
...
export const ProfileTab = ({
  ...
  const hasPendingEmailChange =
    user?.new_email !== undefined && user?.email !== user?.new_email
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        if (onErrorNotification) {
          onErrorNotification(
            t('account.deleteAccount.error.title'),
            errorMessage,
          )
        }
        return
            ...
            <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`text-sm ${errors.firstName
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  {...register('lastName')}
                  disabled={isSubmitting}
                  className={`text-sm ${errors.lastName ? 'border-red-500 focus:border-red-500' : ''
                    }`}
              ...
              <div className="space-y-2 lg:col-span-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className={`text-sm pr-24 ${errors.email ? 'border-red-500 focus:border-red-500' : ''
                      }`}
