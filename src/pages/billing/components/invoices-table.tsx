...
import type { IInvoice, TStatusBilling, IInvoicePagination, IInvoiceQueryParams } from '@/types/billing'
              ...
              <div className='mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between'>
                <div className='text-muted-foreground text-center text-sm sm:text-left'>
                  {t('billing.invoices.showing', {
                    ...
                    to: Math.min(pagination.page * pagination.limit, ((pagination.page - 1) * pagination.limit) + invoices.length),
