...
type TFertilityPhase = 'pre' | 'peri' | 'post'

const PHASE_COLORS: Record<TFertilityPhase, { bg: string; text: string; badge: string }> = {
  pre: {
...
const PHASE_LABEL: Record<TFertilityPhase, string> = {
  pre: 'Przedowulacyjna',
  peri: 'Okołoowulacyjna',
  post: 'Poowulacyjna (niepłodność bezwzględna)',
}
          ...
          <Card>
            ...
            <CardContent className="flex flex-wrap gap-4 text-sm">
              <div className="flex items-center gap-2">
                <div className="h-4 w-4 rounded bg-sky-300 dark:bg-sky-700" />
                <span>Faza przedowulacyjna</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-4 w-4 rounded bg-amber-300 dark:bg-amber-700" />
                <span>Faza okołoowulacyjna</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="h-4 w-4 rounded bg-emerald-300 dark:bg-emerald-700" />
                <span>Faza poowulacyjna (niepłodność bezwzględna)</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            <CardContent className="space-y-5">
              {stats.averageLength === null ? (
                ...
                <>
                  ...
                  {predicted && (
                    <div>
                      <p className="text-sm text-muted-foreground mb-1">Prognozowany następny cykl</p>
